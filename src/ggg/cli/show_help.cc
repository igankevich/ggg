...
ggg::Show_help::print_usage() {
    ...
    std::cout
        ...
        << std::setw(col1) << std::right << "groups  "
        << std::left << "list entity groups\n"
        << std::setw(col1) << std::right << "members  "
        << std::left << "list group members\n"
        << std::setw(col1) << std::right << "parents  "
        << std::left << "list parent entities\n"
        << std::setw(col1) << std::right << "children  "
        << std::left << "list child entities\n"
